...
public class AdminTelevisionCopyMapperImpl implements AdminTelevisionCopyMapper {

    @Override
    public TelevisionWait of(PostingDto posting) {
        if ( posting == null ) {
            return null;
        }

        TelevisionWait televisionWait = new TelevisionWait();

        televisionWait.setCreatedAt( posting.getCreatedAt() );
        televisionWait.setModifiedAt( posting.getModifiedAt() );
        televisionWait.setId( posting.getId() );
        televisionWait.setText( posting.getText() );
        televisionWait.setAttachments( attachmentDtoListToPostingAttachmentList( posting.getAttachments() ) );
        televisionWait.setReadCount( posting.getReadCount() );
        televisionWait.setCommentCount( posting.getCommentCount() );
        televisionWait.setReportCount( posting.getReportCount() );
        televisionWait.setLikeCount( posting.getLikeCount() );
        televisionWait.setScrapCount( posting.getScrapCount() );
        televisionWait.setOwner( userDtoToUser( posting.getOwner() ) );
        televisionWait.setDelete( posting.isDelete() );
        televisionWait.setBlind( posting.isBlind() );
        televisionWait.setAdopt( posting.isAdopt() );
        televisionWait.setGoodses( goodsDtoListToGoodsList( posting.getGoodses() ) );
        televisionWait.setPosters( attachmentDtoListToPosterAttachmentList( posting.getPosters() ) );
        televisionWait.setTitle( posting.getTitle() );
        televisionWait.setYoutubeId( posting.getYoutubeId() );

        return televisionWait;
    }
