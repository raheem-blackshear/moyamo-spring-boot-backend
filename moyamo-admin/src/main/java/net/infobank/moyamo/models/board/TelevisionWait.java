...
@DiscriminatorValue(BoardDiscriminatorValues.TELEVISION_WAIT)
@DynamicUpdate
@ToString(callSuper = true)
/*
 * 모야모TV 대기
 */
public class TelevisionWait extends Posting implements INotification, IPoster<PosterAttachment> {

    @Override
    public PostingType getPostingType() {
        return PostingType.television_wait;
    }
