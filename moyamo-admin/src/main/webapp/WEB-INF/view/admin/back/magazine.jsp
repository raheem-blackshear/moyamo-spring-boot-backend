				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form name="notification_form" id="notification_form" action="/rest/registNotification" method="post">
							...
							<div class="modal-body" style="padding: 0;">
								<div class="card-body">
									<fieldset class="form-group" id="" style="display: block;">
										<div class="row skin skin-square">
                                            <div class="col-md-2 col-sm-12"></div>
                                            <div class="col-md-5 col-sm-12">
                                                <fieldset>
                                                   	<input type="radio" name="noti_type" id="input-radio-0" value="reserve">                                                    		
                                                   	<label for="input-radio-11" class=""><h6 class="text-bold-600"> 알림 예약</h6></label>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-5 col-sm-12">
                                                <fieldset>
                                                   	<input type="radio" name="noti_type" id="input-radio-1" value="immediately">                                                    		
                                                   	<label for="input-radio-11" class=""><h6 class="text-bold-600"> 즉시 발송</h6></label>
                                                </fieldset>
                                            </div>
                                        </div>
									</fieldset>
									<fieldset class="form-group" id="" style="display: block;">
										<div class="col-sm-0 text-left">
											<div class="dataTables_length" id="postingtable_length">
												<label>
													<select id="year" name="year" aria-controls="postingtable" class="custom-select custom-select-sm form-control form-control-sm">
												...
												&nbsp;&nbsp;
												<label>
													<select id="month" name="month" aria-controls="postingtable" class="custom-select custom-select-sm form-control form-control-sm">
												...
												&nbsp;&nbsp;										
												<label>
													<select id="day" name="day" aria-controls="postingtable" class="custom-select custom-select-sm form-control form-control-sm">
														<option value="01">01</option>
														<option value="02">02</option>
														<option value="03">03</option>
														<option value="04">04</option>
...
<!--                                                 <div class="input-group">
                                                    ...
                                                    <input name="noti_date" type='text' class="form-control pickadate datepicker" placeholder="날짜 선택" />
                                                </div>		 -->										
									...
									<fieldset class="form-group" id="fieldsethospital_name_kr" style="display: block;">
										<div class="col-md-12 col-sm-12">
											<div class="row skin skin-flat">
	                                            <div class="col-md-4 col-sm-12"><h6 class="text-bold-600"> 대상 사용자 그룹</h6></div>
	                                            <div class="col-md-6 col-sm-12">
	                                                <div class="skin-states">
		                                                <fieldset>
		                                                    <input type="radio" id="expertGroup" name="expertGroup" value="all">
		                                                    <label for="input-11"> 전체</label>
		                                                </fieldset>
		                                                <fieldset>
		                                                    <input type="radio" id="expertGroup" name="expertGroup" value="name">
		                                                    <label for="input-12"> 식물이름 전문가</label>
		                                                </fieldset>
		                                                <fieldset>
		                                                    <input type="radio" id="expertGroup" name="expertGroup" value="clinic">
		                                                    <label for="input-13"> 클리닉 전문가</label>
		                                                </fieldset>
		                                                <fieldset>
		                                                    <input type="radio" id="expertGroup" name="expertGroup" value="contents">
