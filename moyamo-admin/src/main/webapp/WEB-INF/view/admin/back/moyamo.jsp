				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form name="posting_add_form" id="posting_add_form" action="/admin/registPosting" method="post" enctype="multipart/form-data">
							<input type="hidden" name="postingType" value="question">
										...
										<div class="fonticon-container">
											<div class="custom-file">
												<input type="file" class="custom-file-input"
													id="commentFile" name="commentFile"> <label
													class="custom-file-label" for="commentFile"
													aria-describedby="댓글 첨부"></label>
											</div>
										</div>
									</fieldset>
								</div>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap">
                                        <div class="table-responsive">
                                            <table id="postingtable" class="table table-hover table-striped table-bordered zero-configuration dataex-select-checkbox" style="cursor:pointer;text-align:center;vertical-align:middle;width:100%;">
                                                <thead>
                                                    <tr>
	...
	$(document).ready(function(){
		...
		var table = $('.zero-configuration').DataTable({
            ...
            "createdRow": function( row, data, dataIndex){
            	...
            	$('td', row).attr('data-id', data.DT_RowId); // or whatever you choose to set as the id
            	$('td', row).attr('id', 'id_' + data.DT_RowId); // or whatever you choose to set as the id            	
            }, 	  
            columns: [
	        	{
		        	data : "id",
...
//				commentHtml += "			<input type='file' class='custom-file-input' id='commentFile-"+lastId+"' name='commentFile-"+lastId+"'>			";						                                        	
...
//		console.log('lastId : ' + lastId);
	...
	function blindComment(postingId, commentId) {
