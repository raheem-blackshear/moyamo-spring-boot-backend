...
//				commentHtml += "			<input type='file' class='custom-file-input' id='replyFile-"+lastId+"' name='replyFile-"+lastId+"'>			";						                                        	
				...
				if (children.length > 0) {
					for (var j=0;j<children.length;j++) {	 
						...
						//commentHtml += "&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onclick='javascript:commentModalOpen(" +postingId+ "," +data[i].id + ");'>답글달기</a></br>";	
						commentHtml += "<div style='height:5px;''></div>";
