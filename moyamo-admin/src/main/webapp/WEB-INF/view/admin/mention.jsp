<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	$(document).ready(function(){
		...
		var table = $('.zero-configuration').DataTable({
		    ...
		    'ajax' : {
			    'url': '/rest/comment/getMentionList',
			    'type': 'GET',
			...
			columns: [
                ...
                { data: "orgText", orderable: false}
	            ,{ data: "owner.nickname", orderable: false, searchable: false}
	    ...
	    $('.zero-configuration tbody').on('click', 'td', function () {
                ...
                $.ajax({
                    url : "/rest/getPosting?posting_id=" + dataSet.postingId,
                    type:'GET',
