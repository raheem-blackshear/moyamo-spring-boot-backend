...
<div class="modal-content">
    <div class="modal-header bg-blue-grey">
        <h3 class="modal-title white" style="font-size: 1.1rem;">
            <b id="modal_posting_name"> 인기상품 등록</b>
        </h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="javascript:changeScroll(true);">
            <span aria-hidden="true" style="color: white;">&times;</span>
        </button>
    </div>
    <form name="regist_form" id="regist_form" action="<c:url value="/admin/registBestGoods"/>" method="post">
            ...
            <div class="card-body">
                <fieldset class="form-group" style="display: block;">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <input type="text" class="form-control" id="code1" name="writetitle" placeholder="">
                    </div>
                    <p>2위 상품코드</p>
                    <div class="col-md-12 col-sm-12">
                        <input type="text" class="form-control" id="code2" name="writetitle" placeholder="">
                    </div>
                    <p>3위 상품코드</p>
                    <div class="col-md-12 col-sm-12">
                        <input type="text" class="form-control" id="code3" name="writetitle" placeholder="">
                    </div>
                </fieldset>
