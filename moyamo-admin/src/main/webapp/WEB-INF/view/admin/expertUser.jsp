							...
							<div class="modal-body" style="padding: 0;">
								...
								<div class="container">
									<div class="row align-items-center" style="height: 35px;">
										...
										<div class="col col-2" id="sns"></div>
									</div>
...
<!--                                 <div class="card-header">
    ...
    $(document).ready(function(){
		...
		var table = $('.zero-configuration').DataTable({
            ...
            columns: [
	            ...
	            { data: "expertGroup", render: function (data, type, row, meta) {
	            	var result = '';
	            	if (data != undefined || data!= 'undefined') {
	            		result = groupListView(data);
	            	}
	            	return result;
				  },
				  orderable: false, orderable: false},
	...
	function groupListView(data) {
		var result = "";
    	for(var i=0; i<data.length; i++){
    		console.log(data[i].expertGroup);
        	var strName = "";
    		if (data[i].expertGroup == 'name') {
        		strName = "이름";
        	}
    		if (data[i].expertGroup == 'clinic') {
        		strName = "클리닉";
        	}
    		if (data[i].expertGroup == 'contents') {
        		strName = "컨텐츠";
        	}
    		result += "<div class='badge border-right-success border-left-success badge-striped'><i class='la font-medium-2'></i><span style='bottom: 0px;'>" + strName + "</span></div>&nbsp;&nbsp;";
    	}
    	return result;
	}
