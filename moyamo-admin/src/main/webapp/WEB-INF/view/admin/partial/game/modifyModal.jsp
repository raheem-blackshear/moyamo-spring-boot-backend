...
<div class="modal fade text-left" id="gamble_modify_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
    <div class="modal-dialog" role="document" id="posting_modify_modal_dialog" style="cursor:move;">
        <div class="modal-content">
            ...
            <form name="gamble_modify_form" id="gamble_modify_form" action="/admin/modifyGamble" method="post" enctype="multipart/form-data">
                <input type="hidden" id="gambleId" name="gambleId" value="">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6" style="display:none;">
                                                                    <label>당첨수</label><input type="number" class="form-control" placeholder="당첨수" name="id">
                                                                </div>
                                                                <div class="col-6">
...
<script type="application/javascript">
    $(document).ready(function() {
        /* 달력, 초기화 */
        init_gamble('#gamble_modify_form #startDatepicker');
        init_gamble('#gamble_modify_form #endDatepicker');
    });
</script>
