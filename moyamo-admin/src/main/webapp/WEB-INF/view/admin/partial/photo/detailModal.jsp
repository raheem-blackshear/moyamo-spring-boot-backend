                    ...
                    <div class="card-body" style="padding-top: 1.0rem;padding-right: 1.0rem;padding-bottom: 0.5rem;padding-left: 1.0rem;">
                        ...
                        <div class="media">
                            ...
                            <div class="media-right" style="margin-left: 10px;">
                                ...
                                <% if(postingType == PostingType.magazine) { %>
                                <div class="btn-group">
        ...
        if (commentCnt > 0) {
            for (var i=0;i<data.length;i++) {
                ...
                if (data[i].isDelete) {
                    ...
                    commentHtml += "</br>";
                    commentHtml += timeBefore(data[i].createdAt);
                    commentHtml += "&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='javascript:blindComment(" +postingId+ "," +data[i].id + ", "+ (data[i].isBlind != true)  +");'>"+blindBtnText+"</a></br>";
                } else {
