        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="/admin/dashBoard"><img src="/static/img/moyamo-logo.png" alt="branding logo" style="height: 40px;width: 40px;border-radius: 10%;">
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
						<li class="nav-item mobile-menu d-none d-lg-block"><span id="menuName" style="font-size:1.3rem;font-color:#000000;"><i class="la la-clipboard"></i> ${menuName}</span></li>
                    </ul>
