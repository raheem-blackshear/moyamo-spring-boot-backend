        ...
        var defaults = {
            ...
            templates:          {
                ...
                listItem:         '<li class="mentiony-item" data-item-id="">' +
                    ...
                    '</div>' +
                    '<div class="pl0 col-xs-10 col-sm-10 col-md-10 col-lg-10">' +
                ...
                highlightContent: '<a href="[HREF]" class="mentiony-link" data-item-id="[MENTIONID]">@[TEXT]</a>',
            }
        };
    ...
    var MentionsInput = function (settings) {
        ...
        function populateDropdown(keyword, responseData) {
            ...
            if (responseData.length) {
                ...
                responseData.forEach(function (item, index) {
                    ...
                    if(item.photoUrl)
                        listItem.find('img:first').attr('src', item.photoUrl);
                    listItem.find('p.title:first').html(item.nickname);
                    listItem.find('p.help-block:first').html(item.nickname);
        ...
        function choseMentionOptions(chooseByMouse) {
            ...
            var highlightContentNode = $(settings.templates.highlightContent
                ...
                .replace('[HREF]', '#')
                .replace('[TEXT]', currentMentionItemData.nickname)
                .replace('[MENTIONID]', currentMentionItemData.id)
            );
